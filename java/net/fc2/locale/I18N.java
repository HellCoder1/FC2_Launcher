...
public class I18N {
    ...
    public static Locale currentLocale = Locale.ruRU;
    ...
    private static void getLocaleProperties(String file) {
        locales.clear();
        if (file.equalsIgnoreCase("ruRU")) {
            try {
                locales.load(new InputStreamReader(I18N.class.getResource("/i18n/ruRU").openStream(), "UTF8"));
            } catch (IOException e) {
    ...
    public static void setupLocale() {
        localeFiles.put("ruRU", "Russian");
        synchronized (localeIndices) {
            localeIndices.put(0, "ruRU");
        }
        addFiles();
    ...
    public static void addFiles() {
        ...
        try {
            fallback.clear();
            fallback.load(new InputStreamReader(I18N.class.getResource("/i18n/ruRU").openStream(), "UTF8"));
            Logger.logInfo("[i18n] Fallback ruRU loaded");
        } catch (IOException e) {
    ...
    public static void setLocale(String locale) {
        if (locale == null) {
            ...
            try {
                ...
                Logger.logWarn("[i18n] Unknown locale " + locale + ". Loaded ruRU");
                currentLocale = Locale.ruRU;
            }
        }
    ...
    /**
     * Gets the default translation for the key (ruRU)
     *
