...
public class OSUtils {
    ...
    public static String getDynamicStorageLocation() {
        switch (getCurrentOS()) {
            case WINDOWS:
                return System.getenv("APPDATA") + "/fc2launcher/";
            case MACOSX:
                return cachedUserHome + "/Library/Application Support/fc2launcher/";
            case UNIX:
                return cachedUserHome + "/.fc2launcher/";
            default:
        ...
        switch (getCurrentOS()) {
            case WINDOWS:
                if (System.getenv("LOCALAPPDATA") != null && System.getenv("LOCALAPPDATA").length() > 5)
                    return System.getenv("LOCALAPPDATA") + "/fc2launcher/";
                else
                    return System.getenv("APPDATA") + "/fc2launcher/";
            case MACOSX:
                return cachedUserHome + "/Library/Application Support/fc2launcher/";
